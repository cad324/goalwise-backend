...
class AccountabilityScore(TimeStampMixin):
    ...
    score = models.IntegerField(
        default=500, validators=[MinValueValidator(300), MaxValueValidator(850)]
    )
...
class UserMetrics(TimeStampMixin):
    ...
    task_retention = models.FloatField(
        default=0.95, validators=[MinValueValidator(0), MaxValueValidator(1)]
    )
